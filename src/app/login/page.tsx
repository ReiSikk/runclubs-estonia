...
export default function LoginPage() {
  ...
  return (
    <main className={`${styles.loginForm__section} container`}>
       <Tabs.Root className={styles.tabs__root} defaultValue="tab1" value={activeTab}
      onValueChange={setActiveTab}>
       <Tabs.List className={`${styles.tabs__list} ${activeTab === "tab1" ? 'slide-left' : `${styles.slide_right}`}`} aria-label="Manage your account">
